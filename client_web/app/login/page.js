          ...
          <div style={styles.board}>
            ...
            <div style={{ height: '100%', padding: '1.5em'}}>
              <div style={{flexDirection: 'column', display: 'flex',  height: '40%', justifyContent: 'center'}}>
                ...
                <div style={{ justifyContent: 'center', display: 'flex', padding: '1.3em'}}>
            ...
            <div style={{display: 'flex', justifyContent: 'center', marginTop: '-1.5em'}}>
              <button type="button" onClick={() => signIn('google')} style={{...styles.googleButton}}>
            ...
            <div style={{display: 'flex', justifyContent: 'center', marginTop: '1em'}}>
              <button type="button" onClick={() => signIn('')} style={{...styles.facebookButton}}>
            ...
            <div style={{display: 'flex', justifyContent: 'center', marginTop: '1em'}}>
              <button onClick={() => signIn('spotify')} style={styles.spotifyButton}>Se Connecter avec Spotify</button>
            </div>
